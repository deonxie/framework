        ...
        <div id="collapse1" class="accordion-body collapse in">
            <div class="accordion-inner">
                <ul class="nav nav-list">
                    <li><a href="${ctx}/fuliao/producttype" target="mainFrame"><i class="icon-heart"></i>&nbsp;产品类型管理</a></li>
                    <li><a href="${ctx}/fuliao/users" target="mainFrame"><i class="icon-heart"></i>&nbsp;代购用户管理</a></li>
                    <li><a href="${ctx}/fuliao/shops" target="mainFrame"><i class="icon-heart"></i>&nbsp;代购商家管理</a></li>
                </ul>
            </div>
        </div>
    </div>
