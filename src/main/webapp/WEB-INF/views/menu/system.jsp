        ...
        <div id="collapse1" class="accordion-body collapse in">
            <div class="accordion-inner">
                <ul class="nav nav-list">
                    <li><a href="${ctx}/core/user" target="mainFrame"><i class="icon-heart icon-white"></i>&nbsp;用户管理</a></li>
                    <li><a href="${ctx}/core/role" target="mainFrame"><i class="icon-heart"></i>&nbsp;角色管理</a></li>
                    <li><a href="${ctx}/core/config" target="mainFrame"><i class="icon-heart"></i>&nbsp;系统参数配置</a></li>
                </ul>
            </div>
        </div>
    </div>
